...
namespace msfs_simple_sail_core.Core
{
    internal class Config
    {
        ...
        public bool autoPauseAltActive { get; set; } = false;
        public int autoPauseAltLimit { get; set; } = 1500;
        public bool autoPauseVSActive { get; set; } = false;
        public int autoPauseVSLimit { get; set; } = 3000;
